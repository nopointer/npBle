...
//        ycBleLog.e("ota packet ---> index : " + index + " total : " + this.total + " crc : " + crc + " content : " /* + BleUtil.byte2HexStr(packet, ":")*/);
        return packet;
    }
    ...
    public byte[] getCheckPacket() {
        ...
        int crc = this.crc16(packet);
        this.fillCrc(packet, crc);
//        ycBleLog.e("ota check packet ---> index : " + index + " crc : " + crc + " content : " + BleUtil.byte2HexStr(packet, ":"));
        return packet;
    }
