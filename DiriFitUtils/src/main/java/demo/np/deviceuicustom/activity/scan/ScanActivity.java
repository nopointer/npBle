...
import demo.np.deviceuicustom.activity.dial.DeviceFindMoreDialActivity;
...
public class ScanActivity extends TitleActivity implements ScanListener {
    ...
    public void initView() {
        ...
        BleScanner.getInstance().setBleDeviceFilter(DiriFitDeviceFilter.getInstance());
