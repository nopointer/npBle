...
public final class Downloads implements BaseColumns {
	 ...
	 */
	public static final String AUTHORITY = "com.runChina.itech.downloads";
	 ...
	 * @hide
	 */
	public static final String PERMISSION_ACCESS = "com.runChina.itech.permission.ACCESS_DOWNLOAD_MANAGER";
	 ...
	 * @hide
	 */
	public static final String PERMISSION_ACCESS_ADVANCED = "com.runChina.itech.permission.ACCESS_DOWNLOAD_MANAGER_ADVANCED";

	/**
	 * The permission to access the all the downloads in the manager.
	 */
	public static final String PERMISSION_ACCESS_ALL = "com.runChina.itech.permission.ACCESS_ALL_DOWNLOADS";
	 ...
	 * @hide
	 */
	public static final String PERMISSION_SEND_INTENTS = "com.runChina.itech.permission.SEND_DOWNLOAD_COMPLETED_INTENTS";

	/**
	 * The permission to download files without any system notification being
	 * shown.
	 */
	public static final String PERMISSION_NO_NOTIFICATION = "com.runChina.itech.permission.DOWNLOAD_WITHOUT_NOTIFICATION";
