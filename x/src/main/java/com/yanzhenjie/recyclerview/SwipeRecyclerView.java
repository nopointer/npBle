...
public class SwipeRecyclerView extends RecyclerView {
    ...
    protected XSwipeMenuLayout mOldSwipedLayout;
    ...
    public void smoothOpenLeftMenu(int position) {
        smoothOpenMenu(position, LEFT_DIRECTION, XSwipeMenuLayout.DEFAULT_SCROLLER_DURATION);
    }
    ...
    public void smoothOpenRightMenu(int position) {
        smoothOpenMenu(position, RIGHT_DIRECTION, XSwipeMenuLayout.DEFAULT_SCROLLER_DURATION);
    }
    ...
    public void smoothOpenMenu(int position, @DirectionMode int direction, int duration) {
        ...
        if (vh != null) {
            ...
            if (itemView instanceof XSwipeMenuLayout) {
                mOldSwipedLayout = (XSwipeMenuLayout)itemView;
    ...
    public boolean onInterceptTouchEvent(MotionEvent e) {
        ...
        if (allowSwipeDelete || mSwipeMenuCreator == null) {
            ...
            XSwipeMenuLayout touchView = null;
            if (touchVH != null) {
                View itemView = getSwipeMenuView(touchVH.itemView);
                if (itemView instanceof XSwipeMenuLayout) {
                    touchView = (XSwipeMenuLayout)itemView;
                }
            }
    ...
    private View getSwipeMenuView(View itemView) {
        if (itemView instanceof XSwipeMenuLayout) return itemView;
        ...
        while (!unvisited.isEmpty()) {
            ...
            if (child instanceof XSwipeMenuLayout) return child;
